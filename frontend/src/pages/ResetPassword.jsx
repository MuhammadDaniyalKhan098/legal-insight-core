/**
 * Reset Password Page
 * Reads the reset token from the URL and allows the user to set a new password.
...
const ResetPassword = () => {
  ...
  if (!token) {
    return (
      <div className="relative min-h-[calc(100vh-60px)] bg-gradient-to-br from-gray-950 via-gray-900 to-slate-900 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-gray-900/80 border border-gray-800 p-8 rounded-2xl text-center">
          <p className="text-red-400 mb-4">⚠️ Invalid or missing reset token.</p>
